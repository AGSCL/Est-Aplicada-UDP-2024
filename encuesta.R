...
# google_df <-
# googlesheets4::gs4_create(name = "encuesta_2024", 
#                           # Create a sheet called main for all data to 
#                           # go to the same place
#                           sheets = "main", locale = "es_ES")
# googledrive::drive_get("encuesta_2024")$id
# 
...
ui <- fluidPage(
  surveyOutput(tidyr::unnest(multiQuestions),
               ...
               survey_description = "Servirá para saber cuáles son sus intereses y cuánto saben de las temáticas a abordar. No le tomará más de 5 minutos. No es necesario contar con el programa ni otra información adicional para contestar esta encuesta. Si no conoce la alternativa, conteste al azar.",
               theme = "#DD3333")
)
